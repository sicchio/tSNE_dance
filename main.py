from cnnTSNE_th import *


img_width = 224
img_height = 224
vgg_path = '/Users/sicchio/Downloads/vgg16_weights.h5'
images_path = '/Users/sicchio/Downloads/dance'
...
images = [images[i] for i in range(1,len(images), 3)]
